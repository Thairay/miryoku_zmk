...
U_MT(LGUI, DE_A),     U_MT(LALT, DE_S),     U_MT(LCTRL, DE_D),    U_MT(LSHFT, DE_F),    &kp DE_G,             &kp DE_H,             U_MT(LSHFT, DE_J),    U_MT(LCTRL, DE_K),    U_MT(LALT, DE_L),     U_MT(LGUI, DE_POUND),   \
U_LT(U_BUTTON, DE_Y), U_MT(RALT, DE_X),     &kp DE_C,             &kp DE_V,             &kp DE_B,             &kp DE_N,             &kp DE_M,             &kp DE_COMMA,         U_MT(RALT, DE_DOT),   U_LT(U_BUTTON, DE_DASH),\
